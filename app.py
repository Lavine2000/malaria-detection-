...
# Set up the title
title_label = tk.Label(root, text="Malaria Disease Prediction", font=title_font, bg=primary_color, fg=secondary_color, padx=padx, pady=pady)
...
subtitle_label = tk.Label(root, text="Precision: ", font=subtitle_font, bg=secondary_color, fg=primary_color, padx=padx, pady=pady)
subtitle_label = tk.Label(root, text="Validation Accuracy: ", font=subtitle_font, bg=secondary_color, fg=primary_color, padx=padx, pady=pady)
subtitle_label = tk.Label(root, text="Recall: ", font=subtitle_font, bg=secondary_color, fg=primary_color, padx=padx, pady=pady)
subtitle_label = tk.Label(root, text="F1 Score: ", font=subtitle_font, bg=secondary_color, fg=primary_color, padx=padx, pady=pady)
...
# Set up the footer
footer_label = tk.Label(root, text="©2023 Malaria Disease Prediction using Deep Learning", font=footer_font, bg=secondary_color, fg=footer_color, padx=padx, pady=pady)
